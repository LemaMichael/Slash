...
class PriceContentView: UIView {
    ...
    func setupViews() {
        ...
        percentageLabel.anchor(top: coinPriceLabel.bottomAnchor, bottom: nil, left: self.leftAnchor, right: self.rightAnchor, paddingTop: 4, paddingBottom: 0, paddingLeft: 10, paddingRight: 10, width: 0, height: 22)
